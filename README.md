...
* **O Insight de Negócio & Conclusão Visual:** Ao mudar o foco para uma métrica puramente musical, o desempenho do modelo foi **mais do que triplicado**. Através da análise de importância das variáveis (*Feature Importance*), descobrimos que:
